# Generated by Django 2.0.6 on 2018-11-05 04:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userDownVotes', models.ManyToManyField(blank=True, default=0, related_name='postDownVotes', to=settings.AUTH_USER_MODEL)),
                ('userUpVotes', models.ManyToManyField(blank=True, default=0, related_name='postUpVotes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='answer',
            name='userDownVotes',
            field=models.ManyToManyField(blank=True, default=0, related_name='postAnswerDownVotes', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='answer',
            name='userUpVotes',
            field=models.ManyToManyField(blank=True, default=0, related_name='postAnswerUpVotes', to=settings.AUTH_USER_MODEL),
        ),
    ]
